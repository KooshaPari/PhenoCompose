...
//! latest tag, and prints "up to date" or "outdated: <new>". The actual
//! binary download + apply is a follow-up; this is the seed.

use std::env;

const GITHUB_API: &str = "https://api.github.com/repos/KooshaPari/PhenoCompose/releases/latest";
...
fn parse_latest_tag(body: &str) -> Option<String> {
    // super-lightweight: find "tag_name": "vX.Y.Z" or "X.Y.Z"
    let needle = "\"tag_name\":";
